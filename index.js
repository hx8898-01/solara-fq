...
const SUB_PATH = process.env.SUB_PATH || 'flRI9rwINL4SBiSsrWh9';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || 'ea4edbb1-4a8a-47ae-adcb-b185b9ff4adb'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
